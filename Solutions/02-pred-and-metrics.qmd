...
Accuracy is just one of many, many ways to measure prediction success.  

It is important to choose a metric for model selection that "best" numerically represents your goals in the project.  This is not an easy task!

Check out https://yardstick.tidymodels.org/articles/metric-types.html to see many more options we could have used for this classification problem.
...
> Not necessarily. The variable choices and transformations could have different consequences for different model types.
...
> The decision tree won for recipe 2, but logistic regression with recipe 3 was still best.
